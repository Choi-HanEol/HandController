...
while True:
    ...
    if hands:
        ...
        if len(hands) == 1:
            ...
            # if handType1 == "Right":
            if handright1 == False:
                handGesture1, img, actions, seq_length, model, seq, action_seq = detector.findGesture(img,
                                                                                                      actions=actions,
                                                                                                      seq_length=seq_length,
                                                                                                      model=model,
                                                                                                      seq=seq,
            ...
            if handType1 == "Right" and handright1 == True and (face_direction == "Forward" or before_direction == "Forward"):
            ...
            elif handType1 == "Left" and handright1 == True and (face_direction == "Forward" or before_direction == "Forward"):
            ...
            if handright2 == False:
                handGesture2, img, actions, seq_length, model, seq, action_seq = detector.findGesture(img,
                                                                                                      actions=actions,
                                                                                                      seq_length=seq_length,
                                                                                                      model=model,
                                                                                                      seq=seq,
            ...
            if handType1 == "Left" and handright1 == True and (face_direction == "Forward" or before_direction == "Forward"):
                ##볼륨
                vc.vol_controller(lmList1, volume, volRange, img)
                before_CP = centerPoint1
            elif handType2 == "Left" and handright2 == True and (face_direction == "Forward" or before_direction == "Forward"):
                ## 볼륨
            ...
            elif handType2 == "Right" and handright2 == True and (face_direction == "Forward" or before_direction == "Forward"):
